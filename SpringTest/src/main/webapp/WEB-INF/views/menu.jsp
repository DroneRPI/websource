...
<body>
	<nav id="topMenu" >
		<ul>
			...
			<ul class="submenu">
				<li><a class="submenuLink loginLink" href="http://localhost:8080/test/database.do" target="link">DB정보</a></li>
				<li><a class="submenuLink loginLink" href="http://localhost:8080/test/writeForm.do" target="link">DB정보삭제</a></li>
			</ul>
			<li>|</li>
			...
			<a class="menuLink">Member Management</a>
  			<ul class="submenu">
  				<li><a class="submenuLink loginLink" href="http://localhost:8080/test/writeForm.do" target="link">회원등록</a></li>
  				<li><a class="submenuLink loginLink" href="http://localhost:8080/test/memberlist.do" target="link">회원정보</a></li>
  				<li><a class="submenuLink loginLink" href="http://localhost:8080/test/memberlist.do" target="link">회원 수정/삭제</a></li>
  			</ul>
		</ul>
